...
\headerbox{Figured Bass Entry}{name=figures,column=0,span=1,boxpadding=12pt,below=text}{
...
\headerbox{Chord Entry}{name=chords,column=1,span=1,boxpadding=12pt,aligned=figures}{
...
\headerbox{Variables}{name=variables,column=2,span=2,boxpadding=12pt}{
	...
	Then, we'll display this as chord names, as notes, and as guitar tablature, simply by
  ...
  \headerbox{Classical Music}{name=classical,column=2,span=1,row=.3}{
  ...
  \headerbox{Contemporary Music}{name=rushon,column=3,span=1,aligned=classical}{
