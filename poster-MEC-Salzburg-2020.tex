...
\headerbox{Variables}{name=variables,column=2,span=3,boxpadding=12pt}{
	...
	Then, we'll display this as chord names, as notes, as guitar tablature, and as fretboard
	diagrams, simply by referencing the variable:
	%\vspace{.1em}
  ...
  \headerbox{Classical Music}{name=classical,column=2,span=1,row=.35,headerColorOne=lilyLightHeader2,headerColorTwo=lilyDarkHeader,headerFontColor=white}{
  ...
  \headerbox{Contemporary Music}{name=rushon,column=3,span=1,row=.315,headerColorOne=lilyLightHeader2,headerColorTwo=lilyDarkHeader,headerFontColor=white}{
  ...
  \headerbox{Contemporary Music}{name=keller,column=4,span=1,aligned=rushon,headerColorOne=lilyLightHeader2,headerColorTwo=lilyDarkHeader,headerFontColor=white}{
  ...
  \headerbox{}{column=0,span=5,row=.875,headerColorOne=lilyLightHeader2,headerColorTwo=lilyDarkHeader}{
  	\includegraphics[width=\textwidth]{salzburg-poster.pdf}
  	
  	\small \hfill \hfill \includegraphics[height=1ex]{by-nc-nd-small.eps}\hfill Poster created by Jan-Peter Voigt, Erlend Aasland, Urs Liska
  }
