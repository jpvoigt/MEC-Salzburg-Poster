...
\headerbox{Basic Note Entry}{name=text,column=0,span=1,boxpadding=12pt,below=text}{
	...
	\texttt{4} for fourths, \texttt{8} for eigths, and so on. You can create dotted notes by
	appending dots to the duration digit. Pitch is specified using a variant of the Helmholtz
	pitch notation.
