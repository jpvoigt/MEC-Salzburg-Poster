...
\headerbox{Note Entry}{name=text,column=0,span=1,boxpadding=12pt,below=text}{
  ...
  \headerbox{Classical Music}{name=classical,column=1,span=1}{
  	Excerpt from the Markus Passion by J.S.Bach (BWV 247)
  ...
  \headerbox{Contemporary Music}{name=classical,column=2,span=1}{
  ...
  \headerbox{Contemporary Music}{name=keller,column=3,span=1}{
